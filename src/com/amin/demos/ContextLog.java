...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		out.println("<html>");
		out.println("<head>");
		out.println("<title>Demo: Srevlet Debuging using Message Logging </title>");
		out.println("</head>");
		out.println("<body>");

		context.log("Generation the body for the Response");
		out.println("<h3>Message Logging Demo </h3>");		
		out.println("<p>Message Received : " + param + "</p>");
		context.log("Completed Generation the Response");
